...
var UndoCommand = exports.UndoCommand = function (_Command) {
  _inherits(UndoCommand, _Command);

  function UndoCommand() {
    _classCallCheck(this, UndoCommand);

    return _possibleConstructorReturn(this, (UndoCommand.__proto__ || Object.getPrototypeOf(UndoCommand)).call(this));
  }
